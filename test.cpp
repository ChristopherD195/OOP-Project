...
int main() {
    ...
    mushroom.setPoint(4, sf::Vector2f(70, 120));  // Bottom right of the stalk
    mushroom.setPoint(5, sf::Vector2f(50, 120));  // Bottom center of the stalk
    mushroom.setPoint(6, sf::Vector2f(30, 120));  // Bottom left of the stalk

    // Points for the left side of the cap
    mushroom.setPoint(7, sf::Vector2f(10, 80));   // Lower left of the cap
    mushroom.setPoint(8, sf::Vector2f(30, 50));   // Middle left of the cap
    mushroom.setPoint(9, sf::Vector2f(10, 20));   // Upper left of the cap
