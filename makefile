...
# Source files
SRC = Pizza.cpp PlayerPizza.cpp Topping.cpp Meat.cpp FruitOrVeg.cpp Pepperoni.cpp Chicken.cpp Pineapple.cpp Olive.cpp CustomerPizza.cpp main.cpp Efficiency.cpp
